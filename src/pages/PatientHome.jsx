...
export default function PatientHome() {
    ...
    const checkCovidHandler = (formdata) => {
        ...
        axios
            .post("http://localhost:5000/predictCovid", payload)
            .then((result) => {
                let probability = result.data[0]
                setVitalState("loaded")
                if (probability > 0.5) {
                    setVitalMessage("Your Symptoms indicate you might have Covid , please get tested");
                }
                else {
    ...
    const submitVital = (formdata) => {
        ...
        console.log(arr);
        axios
            .post("https://backend-health-project.onrender.com/predict", arr)
            .then((result) => {
                ...
                <div className="w-10/12 m-auto p-5">
                        ...
                        <div className="absolute mt-3 right-10 w-1/3 z-10  bg-slate-200 h-18 rounded-md ease-in-out duration-300">
                            ...
                            {vitalState === "loaded" && (
                                <div className="message p-4">
                                    <div>
                                        <button onClick={() => closeToast()} className="close float-right cursor-pointer">
                                            X
                                        </button>
                                    </div>
                                    {vitalMessage}
                    ...
                    <div className="flex justify-between items-center w-3/6 border-2 border-slate-300 rounded-md bg-slate-100 m-auto p-5">
                        <div className="group p-6 grid z-10">
                            <p className="text-xl">Name : {data.firstName} {data.lastName}</p>
                        ...
                        <button
                            className="rounded-lg px-6 py-6 max-w-2/6 max-h-16 bg-gray-800 text-blue-100 hover:bg-blue-600 duration-300"
                                ...
                                <div className="bg-white p-8 rounded-lg shadow-lg z-10">
                                    ...
                                    <form onSubmit={handleSubmit((data) => submitVital(data))}>
                                        ...
                                        <label className="block mb-4">
                                            Entry Type
                                            <select
                                                {...register("entryType", { required: "field required" })}
                                                type="text"
                                                className="border rounded-md px-3 py-2 mt-1 w-full"
                                            >
                        ...
                        {checkCovid && (
                            <div className="fixed inset-0 flex items-center justify-center z-50">
                                ...
                                <div className="bg-white p-8 rounded-lg shadow-lg z-10 w-1/3">
                                    ...
                                    <form onSubmit={handleSubmit1((data) => checkCovidHandler(data))}>
                                        <h3 className="text-xl font-bold mb-4">please select your symptoms</h3>
                                        ...
                                        <label className="flex justify-between items-center my-4 w-full">
                                            <p className="w-2/3">Have you experienced fever or chills recently ?</p>
                                            <input
                                        ...
                                        <label className="flex justify-between items-center my-4 w-full">
                                            ...
                                            />
                                            <small className="red">
                                                {errors1.dryCough?.message}
                                            </small>
                                        </label>
                                        <label className="flex justify-between items-center my-4 w-full">
                                            <p className="w-2/3">Have you experienced sore throught ?</p>
                                            <input
                                        ...
                                        <label className="flex justify-between items-center my-4 w-full">
                                            <p className="w-2/3">Do you have congestion or a runny nose ?</p>
                                            <input
                                        ...
                                        <label className="flex justify-between items-center my-4 w-full">
                                            ...
                                            />
                                            <small className="red">
                                                {errors1.Fatigue?.message}
                                            </small>
                                        </label>
                                        <label className="flex justify-between items-center my-4 w-full">
                                            <p className="w-2/3">Have you experienced muscle or body aches?</p>
                                            <input
                                        ...
                                        <label className="flex justify-between items-center my-4 w-full">
                                            <p className="w-2/3">Have you experienced loss of taste or smell ?</p>
                                            <input
